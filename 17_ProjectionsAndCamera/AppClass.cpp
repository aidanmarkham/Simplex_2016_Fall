...
void Application::Display(void)
{
	...
	*/
	...
	m_v3Pos.z -= 1.0f;
	matrix4 m4View = glm::lookAt(vector3(0,10,0) + m_v3Pos, v3View, vector3(0,1,0));
	matrix4 m4Projection = glm::perspective(45.0f, m_pSystem->GetWindowRatio(), 11.01f, 1000.0f);
